...
An analyst with a passion for turning data into impactful stories and strategic decisions. My expertise lies in SQL, data cleaning and analysis, and business process improvement. Currently, at Canada West Warehousing, I am supporting fulfillment operations, inventory management, and data-driven decision making in fast-paced 3PL environment. My week allows me to focus on monitoring order fulfillment, tracking shipments, managing inventory workflows, and analyzing operational performance using WMS, ERP, Power BI, and Excel. Stakeholder collaboration becomes my hangout place. I'm eager to collaborate and contribute to supply chain and business analysis initiatives. Let's connect!
...
- <b>World Layoffs</b>
  - [Data Cleaning](https://github.com/TrushtiBZ/World-Layoffs---Data-Cleaning)
...
- <b> Coffee Bean Processing - Value Stream Mapping (Lean)</b>
  - [Value Stream Mapping](https://github.com/TrushtiBZ/Value-Stream-Mapping-Coffee-Beans-Processing)
